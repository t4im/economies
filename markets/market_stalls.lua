...
minetest.register_node("markets:treasure_box", {
	...
	drop = "default:paper",
	can_dig = economy.markets.defaults.can_dig,
--	on_receive_fields = economy.markets.defaults.on_receive_fields,
--	on_punch = economy.markets.defaults.on_punch,
	allow_metadata_inventory_move = economy.markets.defaults.allow_metadata_inventory_move,
	allow_metadata_inventory_put = economy.markets.defaults.allow_metadata_inventory_put,
	allow_metadata_inventory_take = economy.markets.defaults.allow_metadata_inventory_take,
	on_metadata_inventory_move = economy.markets.defaults.on_metadata_inventory_move,
	on_metadata_inventory_put = economy.markets.defaults.on_metadata_inventory_put,
	on_metadata_inventory_take = economy.markets.defaults.on_metadata_inventory_take,
})
