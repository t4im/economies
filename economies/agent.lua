...
economies.Agent = {
	...
	asOnlinePlayer = function(self) return core.get_player_by_name(self.name) end,
	isAvailable = function(self) return self.type ~= "player" or core.get_player_by_name(self.name) end,
	...
	assertMayInit = function(self, transaction)
